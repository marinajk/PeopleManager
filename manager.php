            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src='ProfilePictures/<?php echo $_SESSION['img'];?>' alt="John Doe" />
                    </div>
                    <h4 class="name"><?php echo $_SESSION['firstname'].' '.$_SESSION['lastname']?></h4>
                    <a href="login.php"><button class="btn-warning" style="padding:10px;">Sign out</button></a>
                </div>
                            ...
                            <div class="col-md-12">
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        <span class="au-breadcrumb-span">Statistics</span>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item">
                                    <h2 class="number"><h2><?php $query="select * from Registration where mid='$uid'";
                                                $result=mysqli_query($conn, $query);
                                                $count = mysqli_num_rows($result);
                                                echo $count; ?></h2></h2>
