                            ...
                            <div class="header-button">
                                <div class="noti-wrap">
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <span class="quantity">
                                            <?php $query="select * from Registration where ut='Admin'";
                                                $result=mysqli_query($conn, $query);
                                                $count = mysqli_num_rows($result);
                                                echo $count; ?></span>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            ...
                                            <div class="account-dropdown__footer">
                                                <a href="login.php">
                                                    <i class="zmdi zmdi-power" name="logout"></i>Logout</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php $query="select * from Registration where ut='Admin'";
                                                $result=mysqli_query($conn, $query);
                                                $count = mysqli_num_rows($result);
                                                echo $count; ?></h2>
                                ...
                                <div class="overview-item overview-item--c2">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php $query="select * from Registration where ut='Manager'";
                                                $result=mysqli_query($conn, $query);
                                                $count = mysqli_num_rows($result);
                                                echo $count; ?></h2>
                                                <span>Managers</span>
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php $query="select * from Registration where ut='Employee'";
                                                $result=mysqli_query($conn, $query);
                                                $count = mysqli_num_rows($result);
                                                echo $count; ?></h2>
                                                <span>Employees</span>
